...
export default function PBG() {
    ...
    const slfHeroContent = {
        ...
        description:
            'Hindari birokrasi yang rumit dan memakan waktu. Tim ahli kami siap mendampingi Anda dari awal hingga PBG terbit, memastikan legalitas bangunan Anda terjamin sepenuhnya. ',
    ...
    const pbgAboutData = {
        ...
        featuresTitle: 'PBG menjamin bangunan Anda:',
        features: [
            {
                label: 'LEGAL',
                description: 'Proyek berjalan sesuai aturan sehingga terhindar dari sanksi hukum.',
            },
            {
                label: 'TERTIB',
                description: 'Pembangunan terkontrol sesuai rencana tata ruang dan fungsi bangunan.',
            },
            {
                label: 'AMAN',
                description: 'Standar teknis dipenuhi sehingga bangunan layak digunakan dan minim risiko.',
            },
            {
                label: 'EFISIEN',
                description: 'Proses pembangunan lebih lancar karena dokumen izin jelas dan sah.',
            },
        ],
        image: {
        ...
        benefits: [
            {
                ...
                description: 'Struktur yang kokoh, proteksi kebakaran, dan jalur evakuasi yang aman.',
            },
            {
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="52" height="52" viewBox="0 0 52 52" fill="none">
                ...
                title: 'Kenyamanan',
                description: 'Pencahayaan, sirkulasi udara, dan sanitasi yang layak.',
            },
            {
                icon: (
                    <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" viewBox="0 0 48 48" fill="none">
                        <g clip-path="url(#clip0_257_440)">
                            <path
                                d="M34.3814 8.30978H31.0454C30.5325 8.30759 30.035 8.48465 29.6388 8.81036C29.2426 9.13607 28.9727 9.58996 28.8757 10.0936C28.7786 10.5972 28.8606 11.1189 29.1074 11.5685C29.3542 12.0181 29.7504 12.3673 30.2274 12.5558L33.6134 13.9098C34.0887 14.099 34.4832 14.448 34.7291 14.8967C34.9749 15.3454 35.0567 15.8657 34.9603 16.3682C34.8639 16.8707 34.5954 17.3238 34.201 17.6497C33.8066 17.9756 33.311 18.1539 32.7994 18.1538H29.4594M31.9214 8.30978V5.92578M31.9214 20.2818V18.1538"
                                stroke="white"
                                stroke-width="3"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                            />
                            <path
                                d="M30.3981 34.8392L42.8321 30.8672L42.9181 30.8432C43.6175 30.6899 44.3488 30.7964 44.9754 31.1427C45.6021 31.4891 46.0812 32.0517 46.3234 32.7255C46.5657 33.3993 46.5544 34.1382 46.2918 34.8043C46.0291 35.4703 45.533 36.0181 44.8961 36.3452C20.6221 48.9132 26.8141 48.3452 1.49609 39.9112M20.6401 13.2312C20.6401 16.2228 21.8285 19.0919 23.9439 21.2073C26.0593 23.3227 28.9285 24.5112 31.9201 24.5112C34.9117 24.5112 37.7808 23.3227 39.8963 21.2073C42.0117 19.0919 43.2001 16.2228 43.2001 13.2312C43.2001 10.2395 42.0117 7.37042 39.8963 5.25501C37.7808 3.1396 34.9117 1.95117 31.9201 1.95117C28.9285 1.95117 26.0593 3.1396 23.9439 5.25501C21.8285 7.37042 20.6401 10.2395 20.6401 13.2312Z"
                                stroke="white"
                                stroke-width="3"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                            />
                            <path
                                d="M1.5 24.5109H5.9C11.0142 24.4591 15.9753 26.2543 19.872 29.5669L19.954 29.6389H28.154C28.9722 29.6367 29.7577 29.9597 30.3378 30.5368C30.9178 31.1138 31.2449 31.8977 31.247 32.7159C31.2491 33.534 30.9261 34.3196 30.3491 34.8996C29.772 35.4797 28.9882 35.8067 28.17 35.8089L15.702 35.8709"
                                stroke="white"
                                stroke-width="3"
                                stroke-linecap="round"
                                stroke-linejoin="round"
                ...
                title: 'Kemudahan',
                description: 'Aksesibilitas yang memadai bagi semua pengguna.',
            },
            {
                icon: (
                ...
                description: 'Memberikan perlindungan dan legalitas penuh atas aset properti Anda.',
            },
        ],
    };
        ...
        advantages: [
            {
                ...
                description: 'Para profesional yang menguasai regulasi bangunan gedung terbaru.',
            },
            {
                ...
                description: 'Anda tahu progres setiap tahap, tanpa biaya tersembunyi.',
            },
            {
                icon: `<svg xmlns="http://www.w3.org/2000/svg" width="42" height="42" viewBox="0 0 42 42" fill="none">
                ...
                title: 'Jaringan Luas',
                description: 'Hubungan baik kami dengan instansi terkait membantu memperlancar proses.',
            },
            {
    ...
    const roadmapData = {
        subtitle: 'Roadmap',
        title: 'Proses Perencanaan Bangunan Kami',
        steps: [
            {
                number: 1,
                title: 'Konsultasi & Analisis',
                description: 'Menelaah rencana bangunan dan memberi panduan dokumen teknis serta administratif.',
                variant: 'blue',
            },
            {
                number: 2,
                title: 'Persiapan Dokumen',
                description: 'Membantu penyusunan, kelengkapan, dan verifikasi berkas sesuai syarat dinas.',
                variant: 'white',
            },
            {
                number: 3,
                title: 'Verifikasi & Penyesuaian',
                description: 'Memastikan seluruh dokumen sesuai standar agar proses lancar. ',
                variant: 'blue',
            },
            {
                number: 4,
                title: 'Pengajuan & Monitoring',
                description: 'Mengajukan melalui SIMBG dan memantau progres hingga tuntas.',
                variant: 'white',
            },
            {
                number: 5,
                title: 'Pendampingan Hingga Terbit',
                description: 'Mendampingi penuh sampai PBG resmi terbit di tangan Anda.',
                variant: 'blue',
            },
        ],
        topCount: 3,
    ...
    return (
        <>
            <Head title={seo?.title || 'Jasa Pengurusan Persetujuan Bangunan Gedung (PBG)'}>
